const HeroSection = () => {
    return (
        <>
            <div className="flex flex-col items-center justify-center text-white px-4 h-[90vh] bg-[url(./src/assets/background.jpg)] bg-cover bg-center">
                <h2 className=" text-2xl md:text-6xl mb-4 font-bold">Welcome to my website.</h2>
                <p className="text-lg md:text-xl mb-4 font-medium">Your journey start here.</p>
